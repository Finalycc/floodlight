...
class StaticFlowPusher(object):  
    ...
    def init_ip_list(self):
		...
		for line in open('poem.txt'):
			line = f.readline()
			print line
		ip_set_tmp.append(line)
		self.ip_list = ip_set_tmp

    def getIp(self, srcIp):
    	index = (hash(srcIp) + int(time.time()) * 1000) % len(self.ip_list)
...
ip_set_file_path = "/home/finallycc/hide/ip_set"
